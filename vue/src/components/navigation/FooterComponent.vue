        ...
        <div class="max-w-7xl mx-auto">
            ...
            >
                ...
                >
                    ...
                    <a
                        href="https://www.youtube.com/@PickyPicksid"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="text-white hover:text-gray-300"
                    >
                    ...
                    <a
                        href="https://open.spotify.com/artist/2XvjzM97hdxo1Bd5GoydUY?si=y-NATUg6SUS-qBc-vZm7jw"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="text-white hover:text-gray-300"
                    >
                    ...
                    <a
                        href="https://www.tokopedia.com/catharsisempire"
                        target="_blank"
                        rel="noopener noreferrer"
                        class="text-white hover:text-gray-300"
                    >
