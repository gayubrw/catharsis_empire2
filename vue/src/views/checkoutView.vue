    ...
    <div class="min-h-screen bg-black">
        ...
        <div class="container mx-auto px-4 py-8">
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div class="border border-white/10 rounded p-4">
                        ...
                        <div class="flex items-center space-x-2 mb-4">
                            <input
                                ...
                                class="rounded border-white/10"
                            />
                            <label for="saveInfo" class="text-sm text-white/60"
                        ...
                        <div class="flex justify-between items-center">
                            ...
                            <button
                                class="bg-white text-black px-6 py-2 rounded hover:bg-white/90"
                            >
                                Continue to payment
                            </button>
                        </div>
                ...
                <div
                    class="hidden lg:block absolute left-1/2 top-100 bottom-0 w-px bg-white/10 transform -translate-x-1/2"
                ></div>

                <!-- Right Column - Order Summary -->
                <div class="lg:sticky lg:top-8 h-fit mt-[46px]">
                    <!-- Tambahkan mt-[46px] untuk menurunkan sejajar dengan form -->
                    <div class="border border-white/10 rounded p-5">
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div class="text-right">
                                        ...
                                        <p
                                            class="text-white text-sm font-medium mt-1"
                                        >
                                            {{
                                                formatPrice(
                        ...
                        <div class="relative mt-6">
                            ...
                            />
                            <button
                                class="absolute right-3 top-1/2 -translate-y-1/2 text-white hover:text-white/80"
                            >
                                Apply
                            </button>
                        </div>
