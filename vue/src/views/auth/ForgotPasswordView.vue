    ...
    <div class="w-full h-[43rem] bg-black">
        <div class="h-full w-full max-w-md mx-auto px-4 flex flex-col justify-center space-y-6">
            ...
            <div class="text-center">
                <h1 class="text-2xl font-bold mb-2 text-white">Reset Password</h1>
            ...
            <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                <!-- Success Message -->
                <div v-if="emailSent" class="bg-green-900/50 border border-green-500 text-green-200 px-4 py-3 rounded-lg">
                    <p>Password reset instructions have been sent to your email.</p>
                    <p class="text-sm mt-1">Please check your inbox and spam folder.</p>
                </div>
